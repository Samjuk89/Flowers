 <div class="twoBlock_main ">
        <div class="left-block ">
            ...
            <div class="moving__visibleInput-item">
                ...
                <img src="/-images/svg/calendar.svg" alt="" style="top: 15px;">

            </div>
            <div class="moving__visibleInput-block-item" onclick="selectToggle(this)">
                <div class="moving__visibleInput-item">
                    <input type="" name="" placeholder="Поставщик" readonly>
                    <img src="/-images/arrow_down.svg" alt="">
                </div>
                <ul class="nomen__selectHidden flex createHolidayMain_select_list">
                    <li class="nomen__selectItem">
                        <input type="checkbox" name="" id="nomen__selectItem-1">
                        <label for="nomen__selectItem-1">Открытки3222222 2222222222</label>
                    </li>
                    <li class="nomen__selectItem">
                        <input type="checkbox" name="" id="nomen__selectItem-2">
                        <label for="nomen__selectItem-2">Открытки</label>
                    </li>
            ...
            <div class="moving__visibleInput-block-item" onclick="selectToggle(this)">
                <div class="moving__visibleInput-item">
                    <input type="" name="" placeholder="Расхождения" readonly>
                    <img src="/-images/arrow_down.svg" alt="">
                </div>
                <ul class="nomen__selectHidden flex createHolidayMain_select_list">
                    <li class="nomen__selectItem">
            ...
            <div class="moving__visibleInput-block-item" onclick="selectToggle(this)">
                <div class="moving__visibleInput-item">
                    <input type="" name="" placeholder="Статус" readonly>
                    <img src="/-images/arrow_down.svg" alt="">
                </div>
                <ul class="nomen__selectHidden flex createHolidayMain_select_list">
                    <li class="nomen__selectItem">
